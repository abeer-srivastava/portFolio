...
function Contact() {
  return (
    <section className="limelight z-10 flex flex-col items-center min-h-screen px-6 py-20 bg-inherit text-indigo-700 backdrop-blur-sm w-[70%] mt-20 rounded-2xl">
      ...
      <p className="text-indigo-700 text-lg mb-10">
      ...
      <div className="bg-white/60 backdrop-blur-xl rounded-2xl border border-gray-200 p-6 shadow-md hover:shadow-lg transition-all mt-8  grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 w-full max-w-3xl">
        ...
        >
          ...
          <h4 className="text-xl font-semibold text-zinc-800">LinkedIn</h4>
        ...
        >
          ...
          <h4 className="text-xl font-semibold text-zinc-800">GitHub</h4>
        ...
        >
          ...
          <h4 className="text-xl font-semibold text-zinc-800">Twitter (X)</h4>
       ...
       <div className="mt-12 w-full max-w-xl p-8 bg-white/60 backdrop-blur-xl rounded-2xl border border-gray-200  hover:shadow-lg transition-all shadow-md">
        <h4 className="text-2xl font-semibold text-zinc-800 mb-4 text-center">Let’s Connect</h4>
        ...
        <form className="space-y-4 bg-white/60 backdrop-blur-xl rounded-2xl border border-gray-200 p-6 shadow-md hover:shadow-lg transition-all">
          ...
          {/* Email Input */}
          <div>
            <label className="block text-zinc-800 font-medium mb-1">Your Email</label>
            <input 
              type="email" 
              required
              placeholder="yourname@example.com"
              className="w-full px-4 py-2 rounded-lg bg-white/20 text-zinc-800 border border-white/20 focus:outline-none focus:ring-2 focus:ring-indigo-400"
            />
          </div>

          {/* Message Textarea */}
          <div>
            <label className="block text-zinc-800 font-medium mb-1">Message</label>
            <textarea
              required
              rows={4}
