            ...
            <div className="relative">
              ...
              <div className="border-5 border-brutal-black shadow-brutal-lg rotate-2 bg-brutal-gray overflow-hidden w-64 h-64 md:w-80 md:h-80">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="font-jetbrains-mono font-bold text-4xl md:text-6xl text-brutal-black">AS</span>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 -right-4 bg-brutal-lime border-4 border-brutal-black px-4 py-2 shadow-brutal-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold uppercase text-xs">Available for work</span>
                </div>
              </div>
            </div>
          </div>
